...
static s32 func_80021464(s32 sectnum, s32 wallnum)
{
    ...
    if (gpWall[wallnum].nextsector == -1)
    {
        ...
        D_80138814 = ((z - z3) * D_8013877C) + D_80168D00;
        D_80118154 = ((z - z4) * D_8013877C) + D_80168D00;
        func_80020DC4(gpWall[wallnum].cstat);
