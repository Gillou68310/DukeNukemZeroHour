...
/*800DCB10*/ Vp D_800DCB10[8] = {
    ...
    {{ { 0x140, 0xF0, 0x1FF, 0 }, { 0x158, 0x108, 0x1FF, 0 } }},
    {{ { 0x140, 0xF0, 0x1FF, 0 }, { 0x3A8, 0x108, 0x1FF, 0 } }},
    {{ { 0x140, 0xF0, 0x1FF, 0 }, { 0x158, 0x2B8, 0x1FF, 0 } }},
    {{ { 0x140, 0xF0, 0x1FF, 0 }, { 0x3A8, 0x2B8, 0x1FF, 0 } }},
    {{ { 0x280, 0xF0, 0x1FF, 0 }, { 0x280, 0x108, 0x1FF, 0 } }},
    {{ { 0x280, 0xF0, 0x1FF, 0 }, { 0x280, 0x2B8, 0x1FF, 0 } }},
    {{ { 0x280, 0x1E0, 0x1FF, 0 }, { 0x280, 0x1E0, 0x1FF, 0 } }}
};
