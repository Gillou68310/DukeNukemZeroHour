...
/*.comm*/
/*800FCBE4*/ u8 *D_800FCBE4; /*palette*/
...
/*80138810*/ u8 *D_80138810; /*texture*/
...
static void func_80083C40(void)
{
    ...
    {
        if ((D_8012EB50[i].texture != D_80138810) || ((D_8012EB50[i].unk18 & 0x210) != D_80119AA0))
        {
            if (D_8012EB50[i].unk18 & 8)
            {
                ...
                {
                    gDPLoadTextureBlock_4b(D_8012F6F8++, D_8012EB50[i].texture, G_IM_FMT_I, D_8012EB50[i].width, D_8012EB50[i].height, 0,
                                                         G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP,
                                                         6, 6, G_TX_NOLOD, G_TX_NOLOD);
                }
                else
                {
                    gDPLoadTextureBlock_4b(D_8012F6F8++, D_8012EB50[i].texture, G_IM_FMT_CI, D_8012EB50[i].width, D_8012EB50[i].height, 0,
                                                                                G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP,
        ...
        if (D_8012EB50[i].palette != D_800FCBE4)
        {
            if (!(D_8012FD8C->unkC & 0x10000))
            {
                ...
                {
                    gDPLoadTLUT_pal256(D_8012F6F8++, D_8012EB50[i].palette);
                }
            }
            D_800FCBE4 = D_8012EB50[i].palette;
        }
...
static void func_8008482C(void)
{
    ...
    if (D_8012FD8C->unkC & 0x20)
    {
        if (D_8012FD8C->unkC & 0x1000)
        {
            ...
            D_801A6AD0->v.ob[0] = -D_80119A6C->x;
            D_801A6AD0->v.ob[1] = D_80119A6C->y;
            D_801A6AD0->v.ob[2] = D_80119A6C->z;
        ...
        {
            D_8013F924[D_80168D18].v.ob[0] = -D_8016A170[D_80118168.unk1C].x;
            D_8013F924[D_80168D18].v.ob[1] = D_8016A170[D_80118168.unk1C].y;
            D_8013F924[D_80168D18].v.ob[2] = D_8016A170[D_80118168.unk1C].z;
            ...
            D_8013F924[D_80168D18].v.ob[0] = -D_8016A170[D_80118168.unk1A].x;
            D_8013F924[D_80168D18].v.ob[1] = D_8016A170[D_80118168.unk1A].y;
            D_8013F924[D_80168D18].v.ob[2] = D_8016A170[D_80118168.unk1A].z;
            ...
            D_8013F924[D_80168D18].v.ob[0] = -D_8016A170[D_80118168.unk18].x;
            D_8013F924[D_80168D18].v.ob[1] = D_8016A170[D_80118168.unk18].y;
            D_8013F924[D_80168D18].v.ob[2] = D_8016A170[D_80118168.unk18].z;
    ...
    {
        D_8013F924[D_80168D18].v.ob[0] = -D_80118168.unk14[D_80118168.unk1C].x;
        D_8013F924[D_80168D18].v.ob[1] = D_80118168.unk14[D_80118168.unk1C].y;
        D_8013F924[D_80168D18].v.ob[2] = D_80118168.unk14[D_80118168.unk1C].z;
        D_8013F924[D_80168D18].v.tc[0] = D_80118168.unk28 << 6;
        D_8013F924[D_80168D18].v.tc[1] = D_80118168.unk2A << 6;
        D_8013F924[D_80168D18].v.flag = 0;
        D_8013F924[D_80168D18].v.cn[0] = D_8013F924[D_80168D18].v.cn[1] = D_8013F924[D_80168D18].v.cn[2] = 0xFF;
        ...
        D_8013F924[D_80168D18].v.ob[0] = -D_80118168.unk14[D_80118168.unk1A].x;
        D_8013F924[D_80168D18].v.ob[1] = D_80118168.unk14[D_80118168.unk1A].y;
        D_8013F924[D_80168D18].v.ob[2] = D_80118168.unk14[D_80118168.unk1A].z;
        D_8013F924[D_80168D18].v.tc[0] = D_80118168.unk24 << 6;
        D_8013F924[D_80168D18].v.tc[1] = D_80118168.unk26 << 6;
        D_8013F924[D_80168D18].v.flag = 0;
        D_8013F924[D_80168D18].v.cn[0] = D_8013F924[D_80168D18].v.cn[1] = D_8013F924[D_80168D18].v.cn[2] = 0xFF;
        ...
        D_8013F924[D_80168D18].v.ob[0] = -D_80118168.unk14[D_80118168.unk18].x;
        D_8013F924[D_80168D18].v.ob[1] = D_80118168.unk14[D_80118168.unk18].y;
        D_8013F924[D_80168D18].v.ob[2] = D_80118168.unk14[D_80118168.unk18].z;
        D_8013F924[D_80168D18].v.tc[0] = D_80118168.unk20 << 6;
        D_8013F924[D_80168D18].v.tc[1] = D_80118168.unk22 << 6;
        D_8013F924[D_80168D18].v.flag = 0;
        D_8013F924[D_80168D18].v.cn[0] = D_8013F924[D_80168D18].v.cn[1] = D_8013F924[D_80168D18].v.cn[2] = 0xFF;
...
static void func_80085128(void)
{
    ...
    if (D_8012FD8C->unkC & 0x20)
    {
        ...
        {
            D_8013F924[D_80168D18].v.ob[0] = -D_8016A170[D_80118168.unk1E].x;
            D_8013F924[D_80168D18].v.ob[1] = D_8016A170[D_80118168.unk1E].y;
            D_8013F924[D_80168D18].v.ob[2] = D_8016A170[D_80118168.unk1E].z;
    ...
    {
        D_8013F924[D_80168D18].v.ob[0] = -D_80118168.unk14[D_80118168.unk1E].x;
        D_8013F924[D_80168D18].v.ob[1] = D_80118168.unk14[D_80118168.unk1E].y;
        D_8013F924[D_80168D18].v.ob[2] = D_80118168.unk14[D_80118168.unk1E].z;
        D_8013F924[D_80168D18].v.tc[0] = D_80118168.unk2C << 6;
        D_8013F924[D_80168D18].v.tc[1] = D_80118168.unk2E << 6;
        D_8013F924[D_80168D18].v.flag = 0;
        D_8013F924[D_80168D18].v.cn[0] = D_8013F924[D_80168D18].v.cn[1] = D_8013F924[D_80168D18].v.cn[2] = 0xFF;
